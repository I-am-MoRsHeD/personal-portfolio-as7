        ...
        <footer className="bg-muted">
            <div className="container mx-auto py-4 lg:py-16">
                ...
                <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-muted-foreground">
                    If you want to build your dream website and maintain your business,just drop a message to me. Do not hesitate to contact with me.
                </p>
                ...
                <div className='flex flex-row justify-center items-center gap-8 mt-5'>
                    {navigationLinks.map((link) =>
                        <Link
                            key={link.href}
                            href={link.href}
                            className="text-muted-foreground hover:text-primary py-1.5 font-medium text-lg"
                            title={link.label}
                        >
                ...
                <div className='w-full border-t-2 mt-14 pt-10 border-black flex justify-evenly items-center text-xs lg:text-sm font-bold'>
                    <div>
                        <p>Copyright © 2025 - All right reserved</p>
                    </div>
                    <div>
                        <p>Build by Md Morshed</p>
                    </div>
                </div>
            </div>
        </footer>
